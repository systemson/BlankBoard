...
@endif
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      {{ Form::select('permissions[]', \App\Http\Models\Permission::pluck('name','id'), $resource->permissions, array('class' => 'col-sm-12 control-form chosen-select', 'rows' => '4', 'multiple' => 'multiple')) }}
    </div>
  </div>
